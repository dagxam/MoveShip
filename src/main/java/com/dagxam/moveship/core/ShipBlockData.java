...
public class ShipBlockData {
    ...
    public ShipBlockData(Vector relativeOffset, BlockData blockData,
                         BlockState stateSnapshot, ItemStack[] items) {
    ...
    public BlockState getStateSnapshot() { return stateSnapshot; }
